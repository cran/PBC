	    ...
	    int trace, int nREPORT)
{
    ...
    //cout << "REPORT must be > 0 (method = \"L-BFGS-B\")";
    switch(trace) {
    case 2: tr = 0; break;
      ...
      int *fncount, int *grcount, int *fail)
{
    ...
    */
	...
	//error(_("initial value in 'vmmin' is not finite"));
      //cout << "initial value in 'vmmin' is not finite" << endl;
